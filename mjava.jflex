...
%{
  private Symbol token(int type) {
    return new Symbol(type, yycolumn, yyline, yytext());
  }
...
IntegerConst = [:jletterdigit:]([:jletterdigit:])*
BooleanConst = "true" | "false"
CharConst = \'[:jletter:]\'
Constant = {IntegerConst} | {BooleanConst} | {CharConst}
MulOpLeft = "*" | "/" | "%"
Assign = "="
...
{Constant}	{ return token(sym.CONSTANT); }
{Comment}	{ }
